        ...
        private static class InvocationHandler extends InstructionHandler {
            ...
            private void injectRenderArgSetCode(AbstractInsnNode invokeNode) {
                ...
                if (null != templateLiteral) {
                    ...
                    list.add(insnNode);
                    MethodInsnNode invokeTemplateLiteral = new MethodInsnNode(INVOKEVIRTUAL, AsmTypes.ACTION_CONTEXT_INTERNAL_NAME, TEMPLATE_LITERAL_NM, TEMPLATE_LITERAL_DESC, false);
                    list.add(invokeTemplateLiteral);
